...
class FacetConfigurationApi
{
     ...
     */
    public function getFacetConfigurationCollection($category = null, $category2 = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        list($response) = $this->getFacetConfigurationCollectionWithHttpInfo($category, $category2, $currentPage, $pageSize, $pagination);
        return $response;
    }
     ...
     */
    public function getFacetConfigurationCollectionWithHttpInfo($category = null, $category2 = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        $returnType = '\Gally\Rest\Model\FacetConfigurationFacetConfigurationRead[]';
        $request = $this->getFacetConfigurationCollectionRequest($category, $category2, $currentPage, $pageSize, $pagination);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFacetConfigurationCollectionAsync($category = null, $category2 = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        return $this->getFacetConfigurationCollectionAsyncWithHttpInfo($category, $category2, $currentPage, $pageSize, $pagination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFacetConfigurationCollectionAsyncWithHttpInfo($category = null, $category2 = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        $returnType = '\Gally\Rest\Model\FacetConfigurationFacetConfigurationRead[]';
        $request = $this->getFacetConfigurationCollectionRequest($category, $category2, $currentPage, $pageSize, $pagination);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFacetConfigurationCollectionRequest($category = null, $category2 = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
