...
class FacetConfigurationApi
{
     ...
     * @param  string $sourceFieldCode sourceFieldCode (optional)
     ...
     * @param  string $positionBetween positionBetween (optional)
     * @param  string $positionGt positionGt (optional)
     * @param  string $positionGte positionGte (optional)
     * @param  string $positionLt positionLt (optional)
     * @param  string $positionLte positionLte (optional)
     ...
     */
    public function getFacetConfigurationCollection($search = null, $sourceFieldCode = null, $sourceFieldMetadataEntity = null, $sourceFieldMetadataEntity2 = null, $category = null, $category2 = null, $displayMode = null, $displayMode2 = null, $sortOrder = null, $sortOrder2 = null, $coverageRateBetween = null, $coverageRateGt = null, $coverageRateGte = null, $coverageRateLt = null, $coverageRateLte = null, $maxSizeBetween = null, $maxSizeGt = null, $maxSizeGte = null, $maxSizeLt = null, $maxSizeLte = null, $positionBetween = null, $positionGt = null, $positionGte = null, $positionLt = null, $positionLte = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        list($response) = $this->getFacetConfigurationCollectionWithHttpInfo($search, $sourceFieldCode, $sourceFieldMetadataEntity, $sourceFieldMetadataEntity2, $category, $category2, $displayMode, $displayMode2, $sortOrder, $sortOrder2, $coverageRateBetween, $coverageRateGt, $coverageRateGte, $coverageRateLt, $coverageRateLte, $maxSizeBetween, $maxSizeGt, $maxSizeGte, $maxSizeLt, $maxSizeLte, $positionBetween, $positionGt, $positionGte, $positionLt, $positionLte, $currentPage, $pageSize, $pagination);
        return $response;
    }
     ...
     * @param  string $sourceFieldCode (optional)
     ...
     * @param  string $positionBetween (optional)
     * @param  string $positionGt (optional)
     * @param  string $positionGte (optional)
     * @param  string $positionLt (optional)
     * @param  string $positionLte (optional)
     * @param  int $currentPage The collection page number (optional)
     * @param  int $pageSize The number of items per page (optional)
     * @param  bool $pagination Enable or disable pagination (optional)
     *
    ...
    public function getFacetConfigurationCollectionWithHttpInfo($search = null, $sourceFieldCode = null, $sourceFieldMetadataEntity = null, $sourceFieldMetadataEntity2 = null, $category = null, $category2 = null, $displayMode = null, $displayMode2 = null, $sortOrder = null, $sortOrder2 = null, $coverageRateBetween = null, $coverageRateGt = null, $coverageRateGte = null, $coverageRateLt = null, $coverageRateLte = null, $maxSizeBetween = null, $maxSizeGt = null, $maxSizeGte = null, $maxSizeLt = null, $maxSizeLte = null, $positionBetween = null, $positionGt = null, $positionGte = null, $positionLt = null, $positionLte = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        ...
        $request = $this->getFacetConfigurationCollectionRequest($search, $sourceFieldCode, $sourceFieldMetadataEntity, $sourceFieldMetadataEntity2, $category, $category2, $displayMode, $displayMode2, $sortOrder, $sortOrder2, $coverageRateBetween, $coverageRateGt, $coverageRateGte, $coverageRateLt, $coverageRateLte, $maxSizeBetween, $maxSizeGt, $maxSizeGte, $maxSizeLt, $maxSizeLte, $positionBetween, $positionGt, $positionGte, $positionLt, $positionLte, $currentPage, $pageSize, $pagination);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFacetConfigurationCollectionAsync($search = null, $sourceFieldCode = null, $sourceFieldMetadataEntity = null, $sourceFieldMetadataEntity2 = null, $category = null, $category2 = null, $displayMode = null, $displayMode2 = null, $sortOrder = null, $sortOrder2 = null, $coverageRateBetween = null, $coverageRateGt = null, $coverageRateGte = null, $coverageRateLt = null, $coverageRateLte = null, $maxSizeBetween = null, $maxSizeGt = null, $maxSizeGte = null, $maxSizeLt = null, $maxSizeLte = null, $positionBetween = null, $positionGt = null, $positionGte = null, $positionLt = null, $positionLte = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        return $this->getFacetConfigurationCollectionAsyncWithHttpInfo($search, $sourceFieldCode, $sourceFieldMetadataEntity, $sourceFieldMetadataEntity2, $category, $category2, $displayMode, $displayMode2, $sortOrder, $sortOrder2, $coverageRateBetween, $coverageRateGt, $coverageRateGte, $coverageRateLt, $coverageRateLte, $maxSizeBetween, $maxSizeGt, $maxSizeGte, $maxSizeLt, $maxSizeLte, $positionBetween, $positionGt, $positionGte, $positionLt, $positionLte, $currentPage, $pageSize, $pagination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFacetConfigurationCollectionRequest($search = null, $sourceFieldCode = null, $sourceFieldMetadataEntity = null, $sourceFieldMetadataEntity2 = null, $category = null, $category2 = null, $displayMode = null, $displayMode2 = null, $sortOrder = null, $sortOrder2 = null, $coverageRateBetween = null, $coverageRateGt = null, $coverageRateGte = null, $coverageRateLt = null, $coverageRateLte = null, $maxSizeBetween = null, $maxSizeGt = null, $maxSizeGte = null, $maxSizeLt = null, $maxSizeLte = null, $positionBetween = null, $positionGt = null, $positionGte = null, $positionLt = null, $positionLte = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        ...
        if ($sourceFieldCode !== null) {
            $queryParams['sourceField.code'] = ObjectSerializer::toQueryValue($sourceFieldCode);
        }
        // query params
        ...
        if ($positionBetween !== null) {
            $queryParams['position[between]'] = ObjectSerializer::toQueryValue($positionBetween);
        }
        // query params
        if ($positionGt !== null) {
            $queryParams['position[gt]'] = ObjectSerializer::toQueryValue($positionGt);
        }
        // query params
        if ($positionGte !== null) {
            $queryParams['position[gte]'] = ObjectSerializer::toQueryValue($positionGte);
        }
        // query params
        if ($positionLt !== null) {
            $queryParams['position[lt]'] = ObjectSerializer::toQueryValue($positionLt);
        }
        // query params
        if ($positionLte !== null) {
            $queryParams['position[lte]'] = ObjectSerializer::toQueryValue($positionLte);
        }
        // query params
        if ($currentPage !== null) {
