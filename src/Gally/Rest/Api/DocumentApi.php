...
class DocumentApi
{
    ...
    {
        $this->getDocumentItemWithHttpInfo($id);
    }
    ...
    {
        $returnType = '';
        $request = $this->getDocumentItemRequest($id);
    ...
    /**
     * Operation getDocumentItemAsync
     *
     * Retrieves a Document resource.
     *
     * @param  string $id (required)
     ...
     */
    public function getDocumentItemAsync($id)
    {
        return $this->getDocumentItemAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDocumentItemAsyncWithHttpInfo
     *
     * Retrieves a Document resource.
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentItemAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->getDocumentItemRequest($id);
    ...
    /**
     * Create request for operation 'getDocumentItem'
     *
     * @param  string $id (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getDocumentItemRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getDocumentItem'
            );
        }
