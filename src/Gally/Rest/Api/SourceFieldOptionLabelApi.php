...
class SourceFieldOptionLabelApi
{
     ...
     * @throws \Gally\Rest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gally\Rest\Model\SourceFieldOptionLabel[]
     */
    public function getSourceFieldOptionLabelCollection($catalog = null, $catalog2 = null, $sourceFieldOptionSourceField = null, $sourceFieldOptionSourceField2 = null, $orderSourceFieldOptionPosition = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        list($response) = $this->getSourceFieldOptionLabelCollectionWithHttpInfo($catalog, $catalog2, $sourceFieldOptionSourceField, $sourceFieldOptionSourceField2, $orderSourceFieldOptionPosition, $currentPage, $pageSize, $pagination);
        return $response;
    }
     ...
     * @throws \Gally\Rest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gally\Rest\Model\SourceFieldOptionLabel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSourceFieldOptionLabelCollectionWithHttpInfo($catalog = null, $catalog2 = null, $sourceFieldOptionSourceField = null, $sourceFieldOptionSourceField2 = null, $orderSourceFieldOptionPosition = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        $returnType = '\Gally\Rest\Model\SourceFieldOptionLabel[]';
        $request = $this->getSourceFieldOptionLabelCollectionRequest($catalog, $catalog2, $sourceFieldOptionSourceField, $sourceFieldOptionSourceField2, $orderSourceFieldOptionPosition, $currentPage, $pageSize, $pagination);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gally\Rest\Model\SourceFieldOptionLabel[]',
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSourceFieldOptionLabelCollectionAsync($catalog = null, $catalog2 = null, $sourceFieldOptionSourceField = null, $sourceFieldOptionSourceField2 = null, $orderSourceFieldOptionPosition = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        return $this->getSourceFieldOptionLabelCollectionAsyncWithHttpInfo($catalog, $catalog2, $sourceFieldOptionSourceField, $sourceFieldOptionSourceField2, $orderSourceFieldOptionPosition, $currentPage, $pageSize, $pagination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSourceFieldOptionLabelCollectionAsyncWithHttpInfo($catalog = null, $catalog2 = null, $sourceFieldOptionSourceField = null, $sourceFieldOptionSourceField2 = null, $orderSourceFieldOptionPosition = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
        $returnType = '\Gally\Rest\Model\SourceFieldOptionLabel[]';
        $request = $this->getSourceFieldOptionLabelCollectionRequest($catalog, $catalog2, $sourceFieldOptionSourceField, $sourceFieldOptionSourceField2, $orderSourceFieldOptionPosition, $currentPage, $pageSize, $pagination);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSourceFieldOptionLabelCollectionRequest($catalog = null, $catalog2 = null, $sourceFieldOptionSourceField = null, $sourceFieldOptionSourceField2 = null, $orderSourceFieldOptionPosition = null, $currentPage = null, $pageSize = null, $pagination = null)
    {
     ...
     *
     * @param  string $id id (required)
     * @param  \Gally\Rest\Model\SourceFieldOptionLabel $sourceFieldOptionLabel The updated SourceFieldOptionLabel resource (optional)
     *
     * @throws \Gally\Rest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gally\Rest\Model\SourceFieldOptionLabel
     ...
     *
     * @param  \Gally\Rest\Model\SourceFieldOptionLabel $sourceFieldOptionLabel The new SourceFieldOptionLabel resource (optional)
     *
     * @throws \Gally\Rest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gally\Rest\Model\SourceFieldOptionLabel
