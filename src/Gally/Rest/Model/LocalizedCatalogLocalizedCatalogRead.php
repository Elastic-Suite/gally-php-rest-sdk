<?php
/**
 * LocalizedCatalogLocalizedCatalogRead
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * LocalizedCatalogLocalizedCatalogRead Class Doc Comment
 *
 * @category Class
 * @package  Gally\Rest
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LocalizedCatalogLocalizedCatalogRead implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LocalizedCatalog-localizedCatalog.read';
    ...
    public function setLocale($locale)
    {
        if ((mb_strlen($locale) > 5)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling LocalizedCatalogLocalizedCatalogRead., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($locale) < 5)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling LocalizedCatalogLocalizedCatalogRead., must be bigger than or equal to 5.');
        }
        if ((!preg_match("/^(.*[a-z]{2}_[A-Z]{2})$/", $locale))) {
            throw new \InvalidArgumentException("invalid value for $locale when calling LocalizedCatalogLocalizedCatalogRead., must conform to the pattern /^(.*[a-z]{2}_[A-Z]{2})$/.");
        }
