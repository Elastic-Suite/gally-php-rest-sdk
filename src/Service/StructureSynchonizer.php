...
class StructureSynchonizer
{
    ...
    public function __construct(
        ...
        $this->localizedCatalogRepository = new LocalizedCatalogRepository($configuration, $environment);
        $this->metadataRepository = new MetadataRepository($configuration, $environment);
        $this->sourceFieldRepository = new SourceFieldRepository($configuration, $environment);
    }
